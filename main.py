...
# ---------------- Restart Function ----------------
def restart_game():
    global player, player_health, player_max_health, player_flash, money
    global ores, bats, raid_number, bats_per_raid, gem_boss_alive
    global prepping, prep_start_time, current_pickaxe, current_sword
    global purchased_pickaxes, purchased_swords, emerald_unlocked, ruby_unlocked, sapphire_unlocked
    global inventory, spawn_timer
    global dead
    dead = False
